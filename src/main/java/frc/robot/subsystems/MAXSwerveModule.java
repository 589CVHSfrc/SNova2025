...
public class MAXSwerveModule {
  ...
  public void stop() {
    ...
    m_drivingClosedLoopController.setReference(0, SparkMax.ControlType.kVelocity);
    m_turningClosedLoopController.setReference(m_turningEncoder.getPosition(), SparkMax.ControlType.kPosition);
  }
